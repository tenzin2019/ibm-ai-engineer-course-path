...
demo = gr.Interface(
    ...
    inputs=[
        ...
        gr.Dropdown(
            ["Data Scientist", "Software Developer", "Software Engineer","AI Engineer"], 
            label="tech_worker_type", 
            info="Will add more tech worker types later!"
        ),
        gr.CheckboxGroup(["Canada", "Japan", "France","Australia"], label="Countries", info="Where are they from?"),
